...
// list of CFIA domain controllers.
...
var language = [177][2]string{
	...
	{"COMPUTER NAME or IP ADDRESS", "NOM DE L'ORDINATEUR ou ADRESSE IP"},
	...
	{"Please enter the NEW PASSWORD", "Entrer le NOUVEAU MOT DE PASSE"},
